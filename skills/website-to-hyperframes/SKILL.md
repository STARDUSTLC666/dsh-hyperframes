...
description: "Capture a website and create a HyperFrames video from it. Use when: (1) a user provides a URL and wants a video, (2) someone says capture this site, turn this into a video, make a promo from my site, (3) the user wants a social ad, product tour, or any video based on an existing website, (4) the user shares a link and asks for any kind of video content. Even if the user just pastes a URL — this is the skill to use. 中文：把网址变成 HyperFrames 视频（产品宣传/广告/产品导览）时使用。"
compatibility: Requires Node.js >= 22 and FFmpeg on PATH; the 7-step pipeline drives `npx hyperframes`.
allowed-tools: Bash
---
